UPDATE `creature_ai_texts` SET `content_loc7` = 'Si sólo tuviera un poco de vino para acompañar con mi queso...' WHERE `entry` = -941;

UPDATE `db_script_string` SET `content_loc7` = 'Mmm... buscan la cabeza de Thaelis el Hambriento. Sería una buena oportunidad para ganarme algo de oro.' WHERE `entry` = 2000000220;
...
UPDATE `locales_gameobject` SET `name_loc7` = 'Buzón' WHERE `entry` = 191320;
