...
UPDATE `game_event` set `description`='Jardin Noble' where `entry`='9';
...
UPDATE `game_event` set `description`='Invasion de la Plaga' where `entry`='17';
UPDATE `game_event` set `description`='Invasion de Elementales' where `entry`='13';
UPDATE `game_event` set `description`='Va a comenzar la Fiesta de la Pesca en Tuercespina' where `entry`='14';
UPDATE `game_event` set `description`='Captura del Botin en Gurubashi Arena' where `entry`='16';
...
UPDATE `game_event` set `description`='¡La Legion Ardiente ataca Ventormenta!' where `entry`='28';
UPDATE `game_event` set `description`='Construccion de la Feria de la Luna Negra (Bosque de Elwynn)' where `entry`='31';
UPDATE `game_event` set `description`='Culto Crepuscular y Invasion  Elementa' where `entry`='48';
...
UPDATE `game_event` set `description`='Dia de los Piratas' where `entry`='32';
...
UPDATE `game_event` set `description`='Competicion de pesca Kalu\'ak' where `entry`='45';
...
UPDATE `game_event` set `description`='La caida de Zalazane' where `entry`='46';
UPDATE `game_event` set `description`='Operacion: Gnomeregan' where `entry`='47';
...
UPDATE `game_event` set `description`='¡Ventormenta se defiende de la Legion Ardiente!' where `entry`='27';
UPDATE `game_event` set `description`='Los lideres de Jin\'Alai, Gawanil' where `entry`='33';
UPDATE `game_event` set `description`='Los lideres de Jin\'Alai, Chulo' where `entry`='39';
...
UPDATE `game_event` set `description`='La Legion Ataca La Ciudad de Shattrath' where `entry`='101';
UPDATE `game_event` set `description`='Invasion de Conejos en Dalaran' where `entry`='105';
UPDATE `game_event` set `description`='Taberna del Fin del Mundo - Anuncio de Perry Gatner' where `entry`='62';
UPDATE `game_event` set `description`='Taberna del Fin del Mundo - Perry Gatner Levanta el Telon' where `entry`='63';
