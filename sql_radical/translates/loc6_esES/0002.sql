...
UPDATE `locales_gossip_menu_option` SET `option_text_loc6` = '¿Qué hace el draco rubí?' WHERE `menu_id` = '27658' AND `id` = '0';
UPDATE `locales_gossip_menu_option` SET `option_text_loc6` = '¿Qué hace el draco esmeralda?' WHERE `menu_id` = '27657' AND `id` = '0';
UPDATE `locales_gossip_menu_option` SET `option_text_loc6` = '¿Qué hace el draco ámbar?' WHERE `menu_id` = '27659' AND `id` = '0';
UPDATE `locales_gossip_menu_option` SET `option_text_loc6` = 'Quiero volar en un draco rubí.' WHERE `menu_id` = '27658' AND `id` = '1';
UPDATE `locales_gossip_menu_option` SET `option_text_loc6` = 'Quiero volar en un draco esmeralda.' WHERE `menu_id` = '27657' AND `id` = '1';
UPDATE `locales_gossip_menu_option` SET `option_text_loc6` = 'Quiero volar en un draco ámbar.' WHERE `menu_id` = '27659' AND `id` = '1';

UPDATE `locales_npc_text` SET `Text0_0_loc6` = '¡Hola, $N!$B$BSé que te gusta mucho cocinar, y es precisamente por ser la festividad de la Generosidad del Peregrino por lo que me gustaría pedirte que me hagas unos cuantos encargos culinarios.$B$BDe recompensa podrás optar por varios de nuestros valiosos objetos típicos de la festividad.$B$B¿Te animas?' WHERE `entry` = 14639;
